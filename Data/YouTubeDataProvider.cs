      ...
      public override ItemDefinition GetItemDefinition(ID itemId, CallContext context)
      {
         ...
         if (CanProcessYouTubeItem(itemId, context))
         {
            ...
            if (itemInfo == null)
            {
               ...
               itemDef = new ItemDefinition(itemId, itemName, ContentDB.Templates[new ID(resourceTemplateID)].ID,
                                            ID.Null);
               _items.Add(itemId, new YTItemInfo(itemId, ID.Parse(resourceTemplateID), itemName, entry.First()));
            }
            else
            {
